...
// Home Route
app[home.method](home.path, (_, res) => res.success(200, 'Welcome to the Product Service API'));

// Health Route
app[health.method](health.path, (_, res) => res.success(200, 'Product Service is healthy'));
