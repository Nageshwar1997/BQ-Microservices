const {
  ...
  CLOUDINARY_IMAGE_SERVICE_DEV_URL,
  CLOUDINARY_IMAGE_SERVICE_PROD_URL,

  CLOUDINARY_VIDEO_SERVICE_DEV_URL,
  CLOUDINARY_VIDEO_SERVICE_PROD_URL,
...
export const envs = {
  ...
  url: {
    ...
    service: {
      ...
      cloudinary_image: is_dev
        ? CLOUDINARY_IMAGE_SERVICE_DEV_URL
        : CLOUDINARY_IMAGE_SERVICE_PROD_URL,
      cloudinary_video: is_dev
        ? CLOUDINARY_VIDEO_SERVICE_DEV_URL
        : CLOUDINARY_VIDEO_SERVICE_PROD_URL,
